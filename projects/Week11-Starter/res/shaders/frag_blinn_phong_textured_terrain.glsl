...
void main() {
	...
	vec4 texPowers = vec4(
		...
		min(GetTextureWeight(height, upperEdge.x, lowerEdge.x), GetTextureWeight(height, upperEdge.y, lowerEdge.y)),
		min(GetTextureWeight(height, upperEdge.y, lowerEdge.y), GetTextureWeight(height, upperEdge.z, lowerEdge.z)),
		GetTextureWeight(height, upperEdge.z, lowerEdge.z)
	);
